...
import styles from "./CustomTemplate3.module.css";

const CustomTemplate3 = ({ onSave, profileImage = null }) => {
      ...
      <div ref={templateRef} className={styles.previewSection}>
        ...
        <div className={styles.leftSection}>
          ...
          <div className={styles.skills}>
            <h3 className={styles.skillshead}>Skills</h3>
            <ul>
...
export default CustomTemplate3;
